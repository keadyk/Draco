...
std::vector<std::vector<std::vector<double>>>ComptonInterp::
                                          interpolate_etemp(const double etemp)
{
  ...
  std::vector<std::vector<std::vector<double>>>interp_data(
    csk_data[0].size(), std::vector<std::vector<double>>(
    csk_data[0][0].size(), std::vector<double>(csk_data[0][0][0].size(), 0.0)));
